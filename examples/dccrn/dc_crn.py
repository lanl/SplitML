...
class DCCRN(nn.Module):
    ...
    def __init__(
        ...
        fix=True
        self.fix = fix
        self.stft = ConvSTFT(self.win_len, self.win_inc, fft_len=fft_len, win_type=self.win_type, feature_type='complex', fix=fix)
        self.istft = ConviSTFT(self.win_len, self.win_inc, fft_len=fft_len, win_type=self.win_type, feature_type='complex', fix=fix)
